...
public class StatisticFederate {
    ...
    public void runFederate() throws RTIexception, InterruptedException {
        ...
        rtiamb.joinFederationExecution( "StatisticFederate", "CashDeskClientFederation", fedamb );
        log( "Joined Federation as StatisticFederate");

        rtiamb.registerFederationSynchronizationPoint( StatisticAmbassador.READY_TO_RUN, null );
        ...
        rtiamb.synchronizationPointAchieved( StatisticAmbassador.READY_TO_RUN );
        log( "Achieved sync point: " + StatisticAmbassador.READY_TO_RUN+ ", waiting for federation..." );
